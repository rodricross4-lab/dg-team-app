...
const baseExercises: Exercise[] = [
  ...
  ['Desenvolvimento máquina','Deltoide anterior','Composto','5-10','2-4 min','Iniciante'],['Elevação lateral cabo','Deltoide lateral','Isolador','10-20','60-90s','Intermediário'],['Elevação lateral máquina','Deltoide lateral','Isolador','10-20','60-90s','Iniciante'],['Crucifixo inverso','Deltoide posterior','Isolador','10-20','60-90s','Iniciante'],['Face pull','Deltoide posterior','Isolador','10-20','60-90s','Intermediário'],
  ['Rosca direta','Bíceps','Isolador','8-15','60-120s','Iniciante'],['Rosca alternada','Bíceps','Isolador','8-15','60-120s','Iniciante'],['Rosca scott','Bíceps','Isolador','8-15','60-120s','Intermediário'],['Rosca martelo','Bíceps','Isolador','8-15','60-120s','Iniciante'],
  ['Tríceps corda','Tríceps','Isolador','8-15','60-120s','Iniciante'],['Tríceps francês','Tríceps','Isolador','8-15','60-120s','Intermediário'],['Tríceps testa','Tríceps','Isolador','8-15','60-120s','Intermediário'],['Paralelas','Tríceps','Composto','5-10','2-4 min','Avançado'],
  ['Agachamento livre','Quadríceps','Composto','5-10','2-4 min','Avançado'],['Hack machine','Quadríceps','Composto','5-10','2-4 min','Intermediário'],['Leg press 45','Quadríceps','Composto','5-10','2-4 min','Iniciante'],['Cadeira extensora','Quadríceps','Isolador','10-15','60-120s','Iniciante'],['Búlgaro','Quadríceps','Composto','5-10','2-4 min','Intermediário'],
  ['Mesa flexora','Posteriores','Isolador','8-15','60-120s','Iniciante'],['Flexora sentada','Posteriores','Isolador','8-15','60-120s','Iniciante'],['Stiff','Posteriores','Composto','6-10','2-4 min','Intermediário'],['RDL','Posteriores','Composto','6-10','2-4 min','Intermediário'],['Good morning','Posteriores','Composto','6-10','2-4 min','Avançado'],
